...
export function QuoteUpload() {
  ...
  return (
    <div
      ...
      className={`relative rounded-lg border-2 border-dashed transition cursor-pointer min-h-[280px] flex flex-col items-center justify-center text-center px-6 py-8 ${
        isParsing
    ...
    >
      ...
      {file && (
        <>
          ...
          <div className="text-sm text-slate-800 font-medium break-all max-w-xl">
            {file.name}
          </div>
